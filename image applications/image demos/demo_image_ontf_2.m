%% online ntf randwalk patches, batch
...
num_batches = 25;
cell_of_cells = cell(1, num_batches);
for b = 1 : num_batches
    image_patches = get_randwalk_image_patches(image, length, width, num_patches);
    cell_of_cells{b} = image_patches;
end

image_patches = zip_cell(cell_of_cells);
